...
So, starting with 1984, we have 25 States that ratified 1 indicator and 3 that ratified 2.  
Today, after 40 years, 109 States have ratified between 3 and 6 for instance, for a grand total of 920 indicators ratified.

<br>

If we want to have a look at each indicator instead, the graph below displays the number of States that had one ratified at a specific point in time, communicating well the increment throughout the years (a gap indicate a year without new ratifications).
